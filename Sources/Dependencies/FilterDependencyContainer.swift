...
//    }
//
//    public func makeListSelectionFilterViewController(from listSelectionListFilterInfo: ListSelectionFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate?) -> FilterViewController_old<ListSelectionFilterViewController>? {
//        let filterViewController = FilterViewController_old<ListSelectionFilterViewController>(filterInfo: listSelectionListFilterInfo, dataSource: navigator.dataSource, selectionDataSource: selectionDataSource, navigator: navigator)
//        filterViewController?.delegate = delegate
//        return filterViewController
//    }
//
//    public func makeMultiLevelListSelectionFilterViewController(from multiLevelListSelectionListFilterInfo: MultiLevelListSelectionFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate?) -> FilterViewController_old<MultiLevelListSelectionFilterViewController>? {
//        let filterViewController = FilterViewController_old<MultiLevelListSelectionFilterViewController>(filterInfo: multiLevelListSelectionListFilterInfo, dataSource: navigator.dataSource, selectionDataSource: selectionDataSource, navigator: navigator)
//        filterViewController?.delegate = delegate
//        return filterViewController
//    }
//
//    public func makeSublevelViewController(for filterInfo: FilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate?) -> FilterViewController_old<MultiLevelListSelectionFilterViewController>? {
...
//    }
//
//    public func makeRangeFilterViewController(with filterInfo: RangeFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate) -> FilterViewController_old<RangeFilterViewController>? {
//        let filterViewController = FilterViewController_old<RangeFilterViewController>(filterInfo: filterInfo, dataSource: navigator.dataSource, selectionDataSource: selectionDataSource, navigator: navigator)
//        filterViewController?.delegate = delegate
//        return filterViewController
//    }
//
...
//    }
//
//    public func makeStepperFilterViewController(with filterInfo: StepperFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate) -> FilterViewController_old<StepperFilterViewController>? {
//        let filterViewController = FilterViewController_old<StepperFilterViewController>(filterInfo: filterInfo, dataSource: navigator.dataSource, selectionDataSource: selectionDataSource, navigator: navigator)
//        filterViewController?.delegate = delegate
//        return filterViewController
//    }
//
//    public func makeMapFilterViewController(from multiLevelListSelectionListFilterInfo: MultiLevelListSelectionFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate?) -> FilterViewController_old<MapFilterViewController>? {
//        let filterViewController = FilterViewController_old<MapFilterViewController>(filterInfo: multiLevelListSelectionListFilterInfo, dataSource: navigator.dataSource, selectionDataSource: selectionDataSource, navigator: navigator)
//        filterViewController?.delegate = delegate
