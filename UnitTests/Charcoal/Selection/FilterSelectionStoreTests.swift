...
final class FilterSelectionStoreTests: XCTestCase {
    ...
    func testIsSelectedWithMap() {
        let filter = Filter.map(title: "Map", key: "map", latitudeKey: "lat", longitudeKey: "lon", radiusKey: "r",
                                locationKey: "loc", bboxKey: "bbox", polygonKey: "polylocation")
...
//        ])
    ...
    func testTitlesWithMap() {
        let filter = Filter.map(title: "Map", key: "map", latitudeKey: "lat", longitudeKey: "lon",
                                radiusKey: "r", locationKey: "loc", bboxKey: "bbox", polygonKey: "polylocation")
        XCTAssertTrue(store.titles(for: filter).isEmpty)
