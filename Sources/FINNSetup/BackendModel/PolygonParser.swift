...
struct PolygonFormatter {
    // MARK: - Polygon

    static func createPolygonCoordinates(from query: String) -> [CLLocationCoordinate2D]? {
    ...
    static func queryForPolygon(from coordinates: [CLLocationCoordinate2D]) -> String {
        var query = ""
    ...
    private func parseBBoxQuery(from query: String) -> [CLLocationCoordinate2D]? {
        guard
    ...
    private static func queryForBbox(from coordinates: [CLLocationCoordinate2D]) -> String {
        let bboxCoordinates = [
