...
public protocol ViewControllerFactory: SublevelViewControllerFactory {
    ...
    func makeSearchTermFilterViewController(from searchTermFilterInfo: SearchTermFilterInfoType, navigator: FilterNavigator, delegate: FilterViewControllerDelegate?) -> UIViewController?
}
